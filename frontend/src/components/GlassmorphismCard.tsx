...
const GlassmorphismCard: React.FC<GlassmorphismCardProps> = ({
  ...
  onClick,
  className = "",
  titleGradient = "from-blue-300 to-purple-400",
  descriptionGradient = "from-blue-100 to-purple-100",
  buttonGradient = "",
  imageSrc = "/debt.png",
  tiltEffect = true,
}) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 
          className={`text-3xl font-bold mb-3 bg-gradient-to-r ${titleGradient} bg-clip-text text-transparent`}
          style={{
        ...
        <p 
          className={`mb-6 bg-gradient-to-r ${descriptionGradient} bg-clip-text text-transparent font-medium`}
          style={{
